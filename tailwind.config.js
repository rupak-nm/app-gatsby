...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      "display-2xl": [
        "4.5rem",
        { lineHeight: "5.625", letterSpacing: "-0.02em" },
      ], // 72px | 405px
      "display-xl": [
        "3.75rem",
        { lineHeight: "4.5", letterSpacing: "-0.02em" },
      ], // 60px | 270px
    ...
    fontFamily: {
      ...
      arial:
        'Arial, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue",sans-serif',
    },
    extend: {
      letterSpacing: {
        2: "0.02em",
      ...
      backgroundImage: {
        ...
        "dashed-border":
          "linear-gradient(to right, #B0C4DB 50%, transparent 50%)",
      },
      backgroundSize: {
        "dashed-size": "20px",
      },
