...
const CoveragePeriodStep = ({
  ...
  return (
    <div className="mt-6">
      <p className="font-bold text-center capitalize text-display-xs text-01052D">
      ...
      <div className="relative flex">
        ...
        />
        <div
          className="absolute h-2 bg-4E7DD9 border-l-white border-l-2 border-r-white border-r-2 top-1.5"
      ...
      <div className="w-full px-2 py-6 text-center rounded-lg mt-11 md:px-8 bg-F3F5F7">
        <div className="flex justify-between font-semibold uppercase">
          <span className="w-1/2 text-left">Your Cover Amount: </span>
          <span className="w-1/2 font-normal text-right">
            {value} {tokenSymbol}
          </span>
        </div>
        <div className="flex justify-between mt-4 font-semibold uppercase">
          <span className="w-1/2 text-left">Cover Expires On:</span>
