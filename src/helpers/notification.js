...
const actionMessages = () => {
  return {
    [METHODS.VOTE_ESCROW_UNLOCK_APPROVE]: (status, _data) => {
      ...
      return {
        title: t`Approving veNPM for unlock`,
        description: displayValue(_data),
      };
    },
    ...
    [METHODS.RESOLVE_INCIDENT_COMPLETE]: (status, _data) => {
      ...
      return {
        title: t`Emergency resolving incident`,
        description: displayValue(_data),
      };
    },
    ...
    [METHODS.LIQUIDITY_PROVIDE]: (status, _data) => {
      ...
      if (status === STATUS.FAILED) {
        return {
          title: t`Could not provide liquidity`,
          description: displayValue(_data),
        };
      }

      return {
        title: t`Providing Liquidity...`,
        description: displayValue(_data),
      };
    },
    [METHODS.REPORTING_UNSTAKE]: (status, _data) => {
      ...
      if (status === STATUS.FAILED) {
        return {
          title: t`Could not unstake ${symbol}`,
          description: displayValue(_data),
        };
      }

      return {
        title: t`Unstaking ${symbol}`,
        description: displayValue(_data),
      };
    },
    [METHODS.REPORTING_UNSTAKE_CLAIM]: (status, _data) => {
      ...
      if (status === STATUS.FAILED) {
        return {
          title: t`Could not unstake & claim ${symbol}`,
          description: displayValue(_data),
        };
      }

      return {
        title: t`Unstaking & claiming ${symbol}`,
        description: displayValue(_data),
      };
    },
    [METHODS.POOL_CAPITALIZE]: (status, _data) => {
      ...
      if (status === STATUS.FAILED) {
        return {
          title: t`Could not capitalize pool`,
          description: displayValue(_data),
        };
      }

      return {
        title: t`Capitalizing pool`,
        description: displayValue(_data),
      };
    },
    ...
    [METHODS.INCIDENT_FINALIZE]: (status, _data) => {
      ...
      if (status === STATUS.FAILED) {
        return {
          title: t`Could not finalize incident`,
          description: displayValue(_data),
        };
      }

      return {
        title: t`Finalizing incident`,
        description: displayValue(_data),
      };
    },
    ...
    [METHODS.UPDATE_WITHDRWAL_WINDOW]: (status, _data) => {
      ...
      return {
        title: t`Updating withdrawal period`,
        description: displayValue(_data),
      };
    },
    ...
    [METHODS.GAUGE_POOL_TOKEN_APPROVE]: (status, _data) => {
      ...
      return {
        title: t`Approving ${tokenSymbol} token`,
        description: displayValue(_data),
      };
    },
    [METHODS.GAUGE_POOL_DEPOSIT]: (status, _data) => {
      ...
      return {
        title: t`Locking ${tokenSymbol} token`,
        description: displayValue(_data),
      };
    },
    [METHODS.GAUGE_POOL_WITHDRAW]: (status, _data) => {
      ...
      return {
        title: t`Unlocking ${tokenSymbol} token`,
        description: displayValue(_data),
      };
    },
