...
export const PolicyCardFooter = ({
  ...
  if (withinClaimPeriod) {
    stats.push({
      ...
      tooltipText: DateLib.toLongDateFormat(claimExpiresAt, router.locale),
    ...
    stats.push({
      ...
      tooltipText: DateLib.toLongDateFormat(claimBeginsFrom, router.locale),
  ...
  return (
    <>
      ...
      {isClaimable && withinClaimPeriod && !isPolicyExpired && (
        <Link
          to={Routes.ClaimPolicy(coverKey, productKey, incidentDate)}
