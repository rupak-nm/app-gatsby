...
export const PoliciesExpiredPage = () => {
  const { data: expiredPolicies, loading } = useExpiredPolicies();

  return (
    <Container className="py-16">
      <div className="flex justify-end">
        <Link
          to={Routes.PolicyTransactions}
        ...
        {data.map((policyInfo) => {
          ...
          return (
            <PolicyCard
              ...
              coverOrProductData={
                isDiversified
                  ? getProduct(policyInfo.coverKey, policyInfo.productKey)
                  : getCoverByCoverKey(policyInfo.coverKey)
              }
            />
          );
        })}
