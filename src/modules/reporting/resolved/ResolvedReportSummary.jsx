...
import { convertFromUnits, isGreater, sumOf, toBN } from "@/utils/bn";
...
export const ResolvedReportSummary = ({
  ...
  const yesPercent = toBN(votes.yes)
    .dividedBy(sumOf(votes.yes, votes.no))
    .decimalPlaces(2)
    .toNumber();
  const noPercent = toBN(1).minus(yesPercent).decimalPlaces(2).toNumber();
