...
import { CoverStatus, MULTIPLIER } from "@/src/config/constants";
    ...
    <OutlinedCard className="p-6 bg-white" type="link">
        ...
        {isDiversified && (
          <InfoTooltip
            infoComponent={
              <p>
                <Trans>
                  Diversified pool with {coverOrProductData.leverage}x leverage
                  factor and{" "}
                  {formatPercent(
      ...
      <div
        className={classNames(
          "justify-between px-1 text-xs lg:text-sm",
          loading ? "hidden" : "flex"
        )}
      >
      ...
      <div
        className={classNames(
          "justify-between px-1 text-01052D opacity-40 text-xs lg:text-sm",
          loading ? "hidden" : "flex"
        )}
      >
        <InfoTooltip
