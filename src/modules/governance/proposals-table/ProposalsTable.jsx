  ...
  return [
    {
      ...
      align: "left",
      renderHeader,
      renderData: (row, { locale }) => {
        return <WhenRenderer row={row} locale={locale} />;
      },
    },
    {
      id: "type",
    ...
    },
    {
      ...
      align: "right",
      renderHeader,
      renderData: (row, { networkId }) => {
        return <ActionsRenderer row={row} networkId={networkId} />;
      },
    },
  ];
};
...
export const ProposalsTable = () => {
  ...
  const { data, fetchProposals, loading, lastFetchedLength } =
    ...
    <div className="mt-8">
      <TitleComponent
        ...
        setFilter={(val) => {
          ...
          fetchProposals({
            page: 1,
            rowsPerPage,
            titleFilter: getFilterString(val),
          });
          setFilter(val);
          setPage(1);
        }}
      ...
      <TableWrapper
        className={classNames(
          "mt-0",
          showMore ? "rounded-none" : "rounded-t-none"
        )}
      >
        <Table>
          <THead
            theadClass="rounded-t-none bg-F9FAFA"
