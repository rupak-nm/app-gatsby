...
export const LiquidityGaugeBoostDetails = ({
  ...
  const formattedTokenValue = formatCurrency(
    convertFromUnits(currentDistribution, rewardTokenDecimals).toString(),
    router.locale,
    "",
    true,
    true
  ...
  return (
    <div className="flex flex-col gap-2 mt-6 md:mt-0">
      <div className="flex flex-row items-center gap-1">
        ...
        <InfoTooltip
          infoComponent={`${
            formattedTokenValue.long
          } NPM emission in epoch #${currentEpoch}. Epoch duration is ${explainInterval(
            epochDuration
          )}.`}
          className="text-xs px-2 py-0.75 bg-opacity-100 max-w-none"
          align="end"
