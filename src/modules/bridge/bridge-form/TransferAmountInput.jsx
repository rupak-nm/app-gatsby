...
import { convertFromUnits, convertToUnits, toBNSafe } from "@/utils/bn";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 p-2 text-sm font-semibold bg-EEEEEE w-max rounded-2">
        <TokenOrCoverLogo src="/images/tokens/npm.svg" alt="NPM logo" />
        ...
        <button
          ...
          onClick={() => {
            return onValueChange(
              convertFromUnits(balance, tokenDecimals).toString()
            );
          }}
        >
          MAX
