...
import { DestinationBalanceError } from "@/modules/bridge/bridge-form/DestinationBalanceError";
...
export const LayerZeroBridgeModule = ({
      ...
      },
      {
        ...
        info: (
          <>
            ...
            {formattedCurrentGasChainPrice.long}.<br />
  ...
  return (
    <div className="flex-grow p-4 lg:p-8 lg:max-w-450">
      <h1 className="text-xl font-semibold lg:text-display-xs">
        LayerZero Bridge
      </h1>
