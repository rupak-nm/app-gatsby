...
export const BridgeOption = ({
  ...
  const logo =
    type === BRIDGE_KEYS.CELER
      ? "/images/bridge/celer.svg"
      : "/images/bridge/layer-zero.svg";

  return (
    <button
      className={classNames(
        "rounded-big box-border overflow-hidden border-2 block w-full lg:w-auto",
        selected ? "border-4E7DD9" : "border-transparent"
      )}
      onClick={onClick}
    >
      <div
        className={classNames(
          ...
          selected
            ? "bg-4E7DD9 bg-opacity-10 border-transparent"
            : "border-B0C4DB bg-white lg:bg-F3F5F7"
        )}
      >
