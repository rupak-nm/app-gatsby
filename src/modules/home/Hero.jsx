...
export const HomeHero = ({ breadcrumbs = [], title = "" }) => {
  ...
  const currentCapacity =
    totalCapacity && totalCapacity.length > 0
      ? totalCapacity[totalCapacity.length - 1].value
      : "0";
                ...
                items={[
                  {
                    ...
                    amount: formatCurrency(currentCapacity, router.locale)
                      .short,
                  },
                  {
                ...
                items={[
                  {
                    ...
                    amount: formatCurrency(heroData.covered, router.locale)
                      .short,
                  },
                  {
                    name: t(i18n)`Cover Fee`,
                    amount: formatCurrency(heroData.coverFee, router.locale)
                      .short,
                  },
                ]}
        ...
        <div className="flex flex-col flex-1 min-w-0 bg-white rounded-2xl shadow-homeCard px-6 py-8 lg:p-14 border-0.5 border-B0C4DB">
          <div className="mb-8">
            ...
            <div className="flex items-center">
              ...
              >
                {formatCurrency(changeData?.last, router.locale).short}
              </h2>
