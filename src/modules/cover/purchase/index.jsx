...
export const CoverPurchaseDetailsPage = () => {
  ...
  const getBreadCrumbs = (
    ...
    if (isDiversified) {
      return [
        ...
        {
          name: coverOrProductData?.coverInfoDetails?.coverName || (
            <Trans>loading...</Trans>
          ),
        ...
        {
          name: coverOrProductData?.productInfoDetails?.productName || (
            <Trans>loading...</Trans>
          ),
  ...
  if (loading) {
    return <PurchasePageSkeleton data-testid="purchase-policy-skeleton" />;
  }
            ...
            <div className="flex justify-center w-full mt-12">
              <PurchasePolicyForm
                ...
                availableForUnderwriting={
                  coverOrProductData?.availableForUnderwriting
                }
