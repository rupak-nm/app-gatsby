...
export const useProvideLiquidity = ({
  ...
  const withdrawalOpenDate = DateLib.toDateFormat(
    withdrawalOpen,
    router.locale
  );
  const withdrawalCloseDate = DateLib.toDateFormat(
    withdrawalClose,
    router.locale
  );
    ...
    try {
      ...
      const onTransactionResult = async (tx) => {
        const logData = {
          ...
          unlockCycleOpenMonthFormatted: getMonthNames(router.locale)[
            parseInt(withdrawalOpenDate.split("/")[0]) - 1
          ],
          ...
          unlockCycleCloseMonthFormatted: getMonthNames(router.locale)[
            parseInt(withdrawalCloseDate.split("/")[0]) - 1
          ],
